...
class PerformanceManagerTest {
    ...
    fun recordsPresentedDroppedAndStartupFromRealMarks() {
        ...
        manager.onEncoderFrame(2_000_000L)
        manager.markPhotoNs(3_000_000L)
        val snap = manager.snapshot()
        ...
        assertThat(snap.encoderFrames).isEqualTo(1)
        assertThat(snap.videoEncodeTimeMs).isEqualTo(2f)
        assertThat(snap.lastPhotoCaptureMs).isEqualTo(3f)
